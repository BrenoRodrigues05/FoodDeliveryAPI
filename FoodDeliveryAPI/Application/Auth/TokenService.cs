    ...
    public class TokenService : ITokenService
    {
        public JwtSecurityToken GenerateToken(IEnumerable<Claim> claims, IConfiguration _config)
        {
            ...
            var tokenDescriptor = new SecurityTokenDescriptor
            {
                ...
                Expires = DateTime.UtcNow.AddMinutes(_config.GetSection("JWT").GetValue<double>("TokenExpiryMinutes")),
        ...
        public string GenerateRefreshToken()
        {
            ...
            var refreshToken = Convert.ToBase64String(secureRandomNumber); return refreshToken;
        }

        public ClaimsPrincipal GetPrincipalFromExpiredToken(string token, IConfiguration _config)
        {
           var secretKey = _config["JWT:SecretKey"] ?? throw new InvalidOperationException("SecretKey not found in configuration.");
